...
React Scrollama is a simple interface for scrollytelling that uses [IntersectionObserver](https://developer.mozilla.org/docs/Web/API/Intersection_Observer_API) in favor of scroll events. It is based off of Russel Goldenbeg's [Scrollama](https://github.com/russellgoldenberg/scrollama/) and was first introduced at [React NYC](https://www.meetup.com/ReactNYC/events/251214926/) (watch the full talk [here](https://www.youtube.com/watch?v=yf5wT2fRgEM)).
